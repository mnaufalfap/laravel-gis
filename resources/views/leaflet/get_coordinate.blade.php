    ...
    <div class="container">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6">
                ...
                <div class="card">
                    <div class="card-header">Titik Koordinat 2</div>
                    <div class="card-body">
                        <div class="form-group">
                            <label for="">Koordinat 2</label>
...
@push('javascript')
    ...
    <script>
        ...
        marker2.on('dragend',function(){
            ...
            $('#coordinate2').val(coordinate2.lat + "," + coordinate2.lng).keyup()
            $('#latitude2').val(coordinate2.lat).keyup()
            $('#longitude2').val(coordinate2.lng).keyup()
        })
