...
class CentrePointController extends Controller
{
    ...
    {
        $user = Auth::user()->name;
        return view('backend.CentrePoint.index', ['user' => $user]);
    }
    ...
    {
        $user = Auth::user()->name;
        return view('backend.CentrePoint.create', ['user' => $user]);
    }
    ...
    public function edit(Centre_Point $centrePoint)
    {
        ...
        return view('backend.CentrePoint.edit', ['centrePoint' => $centrePoint, 'user' => $user]);
    }
