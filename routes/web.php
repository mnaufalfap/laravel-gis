...
Route::get('/', function () {
    ...
    return view('landing.landing', ['locations' => $locations]);
});
...
Route::get('/locations/data', [\App\Http\Controllers\Backend\DataController::class, 'locations'])->name('locations.data');
Route::resource('centre-point', (\App\Http\Controllers\Backend\CentrePointController::class));
Route::resource('locations', (\App\Http\Controllers\Backend\LocationsController::class));
